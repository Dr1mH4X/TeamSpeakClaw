...
<div style="display: flex; align-items: center; justify-content: space-between; gap: 20px;">
  <img src="https://repobeats.axiom.co/api/embed/e20c0a7a0fb24465f50fb3882dadf4416456dd24.svg" alt="Repobeats analytics image" style="max-width: 60%;">

  <div style="flex: 1; text-align: right;">
    <a href="https://github.com/Dr1mH4X/TeamSpeakClaw/graphs/contributors">
      <img src="https://contrib.rocks/image?repo=Dr1mH4X/TeamSpeakClaw" alt="Contributors" />
    </a>
  </div>
</div>
