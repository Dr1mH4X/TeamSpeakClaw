...
TeamSpeakClaw is an LLM (Large Language Model) powered intelligent assistant for TeamSpeak.
...
- **🔌 Flexible Skill System**:
  ...
  - **Voice Replay**: Replay speakers in the recording window (`!replay [N] [@Name]`); requires replay config and ACL.
  - **etc.**
