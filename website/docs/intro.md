...
- **🔌 灵活的技能系统 (Skills)**：
    - **音乐控制**：支持两种模式 — ts3audiobot 后端通过私信控制 [TS3AudioBot](https://github.com/Splamy/TS3AudioBot)，或 tsbot_backend 后端通过 HTTP API 控制 [NeteaseTSBot](https://github.com/yichen11818/NeteaseTSBot)。支持点歌、切歌、搜索、音量调节、音效设置等功能。
